...
# number of atoms of each element contained in the molecule and return
# an object (associative array in PHP, Dictionary<string, int> in C#,
...
# each atom inside the bracket on this index. For example, in Fe(NO3)2
